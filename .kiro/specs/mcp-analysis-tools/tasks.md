...
**RED Phase:**
- [x] 1.1 Write tests for `flattenNodes` - flattens high/med/low into single array
- [x] 1.2 Write tests for `filterByRole` - filters by role mapping (button, link, input, heading, image, table, nav, form)
- [x] 1.3 Write tests for `filterInteractive` - returns nodes with actions
- [x] 1.4 Write tests for `getNodeDetails` - retrieves DETAILS by node id
  - File: `server/tests/unit/analysis/node-queries.test.js`
  - _Requirements: FR-1, FR-2_

**GREEN Phase:**
- [x] 1.5 Implement `server/src/analysis/node-queries.js`

#### Step 2: a11y-rules.js - TDD Cycle

**RED Phase:**
- [x] 2.1 Write tests for `missing-aria-label` rule
- [x] 2.2 Write tests for `missing-alt` rule
- [x] 2.3 Write tests for `button-no-name` rule
- [x] 2.4 Write tests for `missing-form-label` rule
  - File: `server/tests/unit/analysis/a11y-rules.test.js`
  - _Requirements: FR-4_

**GREEN Phase:**
- [x] 2.5 Implement `server/src/analysis/a11y-rules.js`

#### Step 3: capture-diff.js - TDD Cycle

**RED Phase:**
- [x] 3.1 Write tests for element matching by selector
- [x] 3.2 Write tests for detecting added/removed elements
- [x] 3.3 Write tests for detecting layout changes (bbox diff)
- [x] 3.4 Write tests for detecting testid changes
  - File: `server/tests/unit/analysis/capture-diff.test.js`
  - _Requirements: FR-5_

**GREEN Phase:**
- [x] 3.5 Implement `server/src/analysis/capture-diff.js`
...
**RED Phase:**
- [x] 4.1 Write integration tests via InMemoryTransport
...
**GREEN Phase:**
- [x] 4.2 Implement `server/src/tools/get-elements-by-role.js`
...
**GREEN Phase:**
- [x] 5.2 Implement `server/src/tools/get-interactive.js`
...
**GREEN Phase:**
- [x] 6.2 Implement `server/src/tools/find-missing-testids.js`
...
**GREEN Phase:**
- [x] 7.2 Implement `server/src/tools/audit-accessibility.js`
...
**GREEN Phase:**
- [x] 8.2 Implement `server/src/tools/compare-captures.js`

#### Step 9: get_annotations + get_annotated_capture - TDD Cycle

**RED Phase:**
- [x] 9.1 Write integration tests for get_annotations
...
- [x] 9.2 Write integration tests for get_annotated_capture
...
**GREEN Phase:**
- [x] 9.3 Implement `server/src/tools/get-annotations.js`
- [x] 9.4 Implement `server/src/tools/get-annotated-capture.js`

### Phase 3: Wire Up + Verify

#### Step 10: Register all tools in index.js
- [x] 10.1 Import and register all 7 new tools in `server/index.js`

#### Step 11: End-to-End Verification
- [x] 11.1 Verify all tests pass: `npm run test:server`
- [x] 11.2 Update CHANGELOG.md
- [x] 11.3 Commit and push
