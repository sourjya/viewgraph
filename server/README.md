...
MCP server that reads ViewGraph capture files from disk and exposes 41 query/analysis/request tools to AI coding assistants via the [Model Context Protocol](https://modelcontextprotocol.io/).
