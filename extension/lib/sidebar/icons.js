...
export function checkIcon(size = 12, color = '#4ade80') {
...
export function chevronLeftIcon(size = 18, color = '#a5b4fc') {
  const s = svg(size, { stroke: color });
...
export function crosshairIcon(size = 12, color = '#93c5fd') {
  const s = svg(size, { stroke: color });
  s.appendChild(el('circle', { cx: '12', cy: '12', r: '10' }));
...
export function tagIcon(size = 12, color = '#6b7280') {
  const s = svg(size, { stroke: color });
