...
export function createHelpCard() {
  ...
  setSvg(collapseBtn, '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="18 15 12 9 6 15"/></svg>');
  ...
  function keycap(text) {
    ...
    Object.assign(k.style, {
      ...
      border: `1px solid ${COLOR.dim}`, background: COLOR.borderLight, color: 'var(--vg-color-text)',
