...
| MCP tools for agents | 37 tools | Browser automation | Component metadata | Runtime debugging | A11y scanning |
...
5. **17 enrichment collectors** in every capture: network requests, console errors, breakpoints, media queries, stacking contexts, focus chain, scroll containers, landmarks, components, axe-core, event listeners, performance, animations, intersection state.
