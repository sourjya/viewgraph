...
| Phase 2 | Puppeteer E2E perf (page load, element count, DOM capture timing) + enrichment verification | 1-2 days | **Done** |
| Phase 3 | GitHub Actions CI workflow + release.sh bundle gate | 0.5 day | **Done** |
...
| PR 3 | Fallback cleanup + CI hex color gate | 0.5 day | **Done** |
