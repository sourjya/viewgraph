    ...
    mcpServers: {
      viewgraph: {
        ...
        autoApprove: [
          ...
          'verify_fix', 'get_capture_history', 'compare_baseline', 'compare_styles',
          'compare_screenshots', 'check_consistency', 'check_annotation_status',
          'diff_annotations', 'detect_recurring_issues', 'analyze_patterns',
